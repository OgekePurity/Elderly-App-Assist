...
const getJournalEntries = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const journalEntries = yield JournalEntry_1.default.find();
...
const addJournalEntry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const journalEntry = new JournalEntry_1.default({ title, content });
...
const updateJournalEntry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedEntry = yield JournalEntry_1.default.findByIdAndUpdate(id, { title, content }, { new: true, runValidators: true });
        if (!updatedEntry) {
...
const deleteJournalEntry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const deletedEntry = yield JournalEntry_1.default.findByIdAndDelete(id);
        if (!deletedEntry) {
            return res.status(404).json({ error: 'Journal entry not found' });
        }
