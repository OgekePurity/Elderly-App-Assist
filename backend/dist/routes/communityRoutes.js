...
router.get('/', authMiddleware_1.default, communityController_1.getCommunityPosts);
router.post('/', authMiddleware_1.default, communityController_1.addCommunityPost);
